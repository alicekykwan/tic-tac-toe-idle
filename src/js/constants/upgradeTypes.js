import { COIN_TYPE_X, COIN_TYPE_O, COIN_TYPE_SUPER_X, COIN_TYPE_SUPER_O, COIN_TYPE_T } from './coinTypes';
...
export const UPGRADE_SHOP_SUPER_O_UNLOCK_3P = 'sou3';
export const UPGRADE_SHOP_T_PRESTIGE_MULT = 'stpm';
